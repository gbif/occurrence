...
<p style="padding: 0;margin-bottom: 20px;line-height: 1.65;">
  الرجاء الاطلاع على <a href="${portal}occurrence/download/${download.key}" style="color: #4ba2ce;text-decoration: none;">${portal}حدث/تنزيل/${download.key}</a> لمزيد من التفاصيل، <a href="${portal}health" style="color: #4ba2ce;text-decoration: none;">${portal}الصحة</a> للوضع الحالي لأنظمة GBIF.org، وحاول مرة أخرى في بضع دقائق.
</p>
