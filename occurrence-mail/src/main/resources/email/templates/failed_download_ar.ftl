...
<p style="padding: 0;margin-bottom: 20px;line-height: 1.65;">
  الرجاء الاطلاع على <a href="${portal}${download.request.type?lower_case}/download/${download.key}" style="color: #4ba2ce;text-decoration: none;">${portal}حدث/تنزيل/${download.key}</a> لمزيد من التفاصيل، <a href="${portal}system-health" style="color: #4ba2ce;text-decoration: none;">${portal}الصحة</a> للوضع الحالي لأنظمة GBIF.org، وحاول مرة أخرى في بضع دقائق.
</p>
