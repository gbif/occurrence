...
public class OccurrenceRelationships {
  private static final String REGEX_IDENTIFIERS = "[-.,_ :|/\\\\#%&]"; // chars to remove from identifiers
  ...
  public static RelationshipAssertion generate(OccurrenceFeatures o1, OccurrenceFeatures o2) {
    ...
    if (assertion.justificationContains(SAME_SPECIMEN) || assertion.justificationContains(TYPIFICATION_RELATION)) {
      return assertion;
    }
    ...
    RelationshipAssertion.FEATURE_ASSERTION[][] passConditions = {
      ...
      {SAME_ACCEPTED_SPECIES, NON_CONFLICTING_COORDINATES, NON_CONFLICTING_DATE, IDENTIFIERS_OVERLAP},
  ...
  private static void compareIdentifiers(OccurrenceFeatures o1, OccurrenceFeatures o2, RelationshipAssertion assertion) {
    ...
    intersection.removeAll(Arrays.asList(null, "", "NOAPLICA", "NA", "[]", "NODISPONIBLE", "NODISPONIBL", "NONUMBER", "--", "UNKNOWN"));
