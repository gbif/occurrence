...
public enum OccurrenceSolrField {
  ...
  ACCEPTED_TAXON_KEY("accepted_taxon_key"), KINGDOM_KEY("kingdom_key"), PHYLUM_KEY("phylum_key"),
  CLASS_KEY("class_key"), ORDER_KEY("order_key"), FAMILY_KEY("family_key"), GENUS_KEY("genus_key"),
  ...
  ISSUE("issue"), ESTABLISHMENT_MEANS("establishment_means"), OCCURRENCE_ID("occurrence_id"),
  ...
  INSTALLATION_KEY("installation_key"), NETWORK_KEY("network_key"),
