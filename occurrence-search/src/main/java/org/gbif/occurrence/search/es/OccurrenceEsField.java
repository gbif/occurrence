...
public enum OccurrenceEsField {
  ...
  GADM_LEVEL_0_GID("level0Gid", GadmTerm.level0Gid),
  GADM_LEVEL_0_NAME("level0Name", GadmTerm.level0Name),
  GADM_LEVEL_1_GID("level1Gid", GadmTerm.level1Gid),
  GADM_LEVEL_1_NAME("level1Name", GadmTerm.level1Name),
  GADM_LEVEL_2_GID("level2Gid", GadmTerm.level2Gid),
  GADM_LEVEL_2_NAME("level2Name", GadmTerm.level2Name),
  GADM_LEVEL_3_GID("level3Gid", GadmTerm.level3Gid),
  GADM_LEVEL_3_NAME("level3Name", GadmTerm.level3Name),
