...
public class EsQueryUtils {
  ...
  public static final ImmutableMap<OccurrenceSearchParameter, OccurrenceEsField> SEARCH_TO_ES_MAPPING =
      ImmutableMap.<OccurrenceSearchParameter, OccurrenceEsField>builder()
          ...
          .put(OccurrenceSearchParameter.GADM_LEVEL_0_GID, OccurrenceEsField.GADM_0_GID)
          .put(OccurrenceSearchParameter.GADM_LEVEL_0_NAME, OccurrenceEsField.GADM_0_NAME)
          .put(OccurrenceSearchParameter.GADM_LEVEL_1_GID, OccurrenceEsField.GADM_1_GID)
          .put(OccurrenceSearchParameter.GADM_LEVEL_1_NAME, OccurrenceEsField.GADM_1_NAME)
          .put(OccurrenceSearchParameter.GADM_LEVEL_2_GID, OccurrenceEsField.GADM_2_GID)
          .put(OccurrenceSearchParameter.GADM_LEVEL_2_NAME, OccurrenceEsField.GADM_2_NAME)
          .put(OccurrenceSearchParameter.GADM_LEVEL_3_GID, OccurrenceEsField.GADM_3_GID)
          .put(OccurrenceSearchParameter.GADM_LEVEL_3_NAME, OccurrenceEsField.GADM_3_NAME)
