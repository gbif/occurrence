...
public class HBaseOccurrenceWriter implements Predicate<Occurrence> {
  ...
  // Column family
  private final static byte[] CF = Bytes.toBytes(TableConstants.OCCURRENCE_COLUMN_FAMILY);
  ...
  private void write(Occurrence occ) throws IOException {
    ...
    if (occ.getElevation() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_ELEVATION).getColumnName()),
    ...
    if (occ.getVerbatimField(DwcTerm.catalogNumber) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.CATALOG_NUMBER).getColumnName()),
    ...
    if (occ.getClazz() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_CLASS).getColumnName()),
        Bytes.toBytes(occ.getClazz()));
    }

    if (occ.getVerbatimField(DwcTerm.collectionCode) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.COLLECTION_CODE).getColumnName()),
        Bytes.toBytes(occ.getVerbatimField(DwcTerm.collectionCode)));
    }

    // deprecated - remove
    // if (occ.getDataProviderId() != null) {
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.DATA_PROVIDER_ID).getColumnName()),
    // Bytes.toBytes(occ.getDataProviderId()));
    // }
    //
    // if (occ.getDataResourceId() != null) {
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.DATA_RESOURCE_ID).getColumnName()),
    ...
    if (occ.getDepth() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_DEPTH).getColumnName()),
        Bytes.toBytes(occ.getDepth()));
    }

    if (occ.getFamily() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_FAMILY).getColumnName()),
    ...
    if (occ.getGenus() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_GENUS).getColumnName()),
    ...
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.I_GEOSPATIAL_ISSUE).getColumnName()),
    // Bytes.toBytes(occ.getGeospatialIssue()));
    // }

    if (occ.getVerbatimField(DwcTerm.institutionCode) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.INSTITUTION_CODE).getColumnName()),
    ...
    if (occ.getDecimalLatitude() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_DECIMAL_LATITUDE).getColumnName()),
        Bytes.toBytes(occ.getDecimalLatitude()));
    }

    if (occ.getDecimalLongitude() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_DECIMAL_LONGITUDE).getColumnName()),
        Bytes.toBytes(occ.getDecimalLongitude()));
    }

    if (occ.getVerbatimField(DwcTerm.locality) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(DwcTerm.locality).getColumnName()),
    ...
    if (occ.getVerbatimField(DwcTerm.county) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(DwcTerm.county).getColumnName()),
    ...
    if (occ.getVerbatimField(DwcTerm.recordedBy) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(DwcTerm.recordedBy).getColumnName()),
        Bytes.toBytes(occ.getVerbatimField(DwcTerm.recordedBy)));
    }

    if (occ.getVerbatimField(DwcTerm.identifiedBy) != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(DwcTerm.identifiedBy).getColumnName()),
    ...
    if (occ.getMonth() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_MONTH).getColumnName()),
    ...
    if (occ.getOrder() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_ORDER).getColumnName()),
    ...
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.I_OTHER_ISSUE).getColumnName()),
    ...
    if (occ.getPhylum() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_PHYLUM).getColumnName()),
    ...
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.RESOURCE_ACCESS_POINT_ID).getColumnName()),
    ...
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.I_TAXONOMIC_ISSUE).getColumnName()),
    // Bytes.toBytes(occ.getTaxonomicIssue()));
    // }

    // TODO: deprecated
    // if (occ.getUnitQualifier() != null) {
    // put.add(CF, Bytes.toBytes(HBaseFieldUtil.getColumn(FieldName.UNIT_QUALIFIER).getColumnName()),
    // Bytes.toBytes(occ.getUnitQualifier()));
    // }

    if (occ.getYear() != null) {
      put.add(CF, Bytes.toBytes(FieldNameUtil.getColumn(FieldName.I_YEAR).getColumnName()),
