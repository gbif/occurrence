...
public class GenerateHQL {
  ...
  public static void generateDwcaQueryHQL(String checklistKey, Writer writer) throws IOException, TemplateException {
    generateDwcaQueryHQL(templateConfig(), checklistKey, writer);
  }
