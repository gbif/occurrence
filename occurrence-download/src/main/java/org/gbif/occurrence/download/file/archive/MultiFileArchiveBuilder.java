...
public class MultiFileArchiveBuilder {
  ...
  // Filtering out .crc files is mostly necessary for testing using a local HDFS.
  private static final FilenameFilter noCrcFilter = (dir, name) -> !name.toLowerCase().endsWith(".crc");
