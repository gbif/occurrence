...
AS SELECT ${extension.interpretedFields?join(", ")} FROM ${r"${tableName}"}_ext_${extension.hiveTableName}
JOIN ${r"${interpretedTable}"} ON ${r"${interpretedTable}"}.gbifid = ${r"${tableName}"}_ext_${extension.hiveTableName}.gbifid
