...
import org.gbif.occurrencestore.interpreters.result.CoordinateInterpretationResult;
import org.gbif.occurrencestore.interpreters.util.RetryingWebserviceClient;
...
public class CoordinateInterpreter {
  ...
  private static final String WEB_SERVICE_URL_PROPERTY = "occurrencestore.geo.ws.url";

  private static final String FUZZY_COUNTRY_FILE;
  private static final String FUZZY_COUNTRY_FILE_PROPERTY = "occurrencestore.geo.fuzzycountryfile";
