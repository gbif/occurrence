...
public class CSVFileBuilder {
  ...
  public static List<String> buildOccurrenceLine(@Nullable Result row) {
    ...
    if (row == null || row.isEmpty()) {
      ...
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_CLASS_ID)));
      ...
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.DATA_PROVIDER_ID)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.DATA_RESOURCE_ID)));
      ...
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.DWC_OCCURRENCE_ID)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.I_FAMILY)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_FAMILY_ID)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.I_GENUS)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_GENUS_ID)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_GEOSPATIAL_ISSUE)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.INSTITUTION_CODE)));
      result.add(OccurrenceResultReader.getString(row, FieldName.I_ISO_COUNTRY_CODE));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.I_KINGDOM)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_KINGDOM_ID)));
      ...
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_NUB_ID)));
      result.add(objectToString(OccurrenceResultReader.getDate(row, FieldName.I_OCCURRENCE_DATE)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.I_ORDER)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_ORDER_ID)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_OTHER_ISSUE)));
      result.add(objectToString(OccurrenceResultReader.getUuid(row, FieldName.OWNING_ORG_KEY)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.I_PHYLUM)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_PHYLUM_ID)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.RESOURCE_ACCESS_POINT_ID)));
      ...
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_SPECIES_ID)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_TAXONOMIC_ISSUE)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.UNIT_QUALIFIER)));
      result.add(objectToString(OccurrenceResultReader.getInteger(row, FieldName.I_YEAR)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.LOCALITY)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.COUNTY)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.STATE_PROVINCE)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.CONTINENT_OCEAN)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.COLLECTOR_NAME)));
      result.add(objectToString(OccurrenceResultReader.getString(row, FieldName.IDENTIFIER_NAME)));
      result.add(objectToString(OccurrenceResultReader.getDate(row, FieldName.IDENTIFICATION_DATE)));
      return result;
    }
  }
