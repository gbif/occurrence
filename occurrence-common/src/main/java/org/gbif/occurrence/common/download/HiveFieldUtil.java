...
public class HiveFieldUtil {
  ...
  public static final List<FieldName> DOWNLOAD_COLUMNS = ImmutableList.of(
    FieldName.ID, FieldName.DATASET_KEY, FieldName.INSTITUTION_CODE, FieldName.COLLECTION_CODE,
    FieldName.CATALOG_NUMBER, FieldName.I_BASIS_OF_RECORD, FieldName.I_SCIENTIFIC_NAME, FieldName.AUTHOR,
    ...
    FieldName.SPECIES, FieldName.SUBSPECIES, FieldName.LATITUDE, FieldName.LONGITUDE, FieldName.LAT_LNG_PRECISION,
    FieldName.MAX_ALTITUDE, FieldName.MIN_ALTITUDE, FieldName.ALTITUDE_PRECISION, FieldName.MIN_DEPTH,
    FieldName.MAX_DEPTH, FieldName.DEPTH_PRECISION, FieldName.CONTINENT_OCEAN, FieldName.STATE_PROVINCE,
    FieldName.COUNTY, FieldName.COUNTRY, FieldName.COLLECTOR_NAME, FieldName.LOCALITY, FieldName.YEAR,
