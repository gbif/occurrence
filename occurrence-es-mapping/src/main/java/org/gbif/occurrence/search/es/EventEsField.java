...
public enum EventEsField implements EsField {
  ...
  KINGDOM_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.kingdomKey.keyword", GbifTerm.kingdomKey)),
  KINGDOM(new BaseEsField("derivedMetadata.taxonomicCoverage.kingdom.keyword", DwcTerm.kingdom)),
