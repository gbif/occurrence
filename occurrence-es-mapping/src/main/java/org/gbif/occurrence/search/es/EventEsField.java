...
public enum EventEsField implements EsField {
  ...
  TAXON_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.taxonKey", GbifTerm.taxonKey)),
  USAGE_TAXON_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usage.key", GbifTerm.taxonKey)),
  TAXON_RANK(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usage.rank", DwcTerm.taxonRank)),
  ACCEPTED_TAXON_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.acceptedUsage.key", GbifTerm.acceptedTaxonKey)),
  ACCEPTED_SCIENTIFIC_NAME(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.acceptedUsage.name", GbifTerm.acceptedScientificName)),
  KINGDOM_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.kingdomKey", GbifTerm.kingdomKey)),
  KINGDOM(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.kingdom", DwcTerm.kingdom)),
  PHYLUM_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.phylumKey", GbifTerm.phylumKey)),
  PHYLUM(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.phylum", DwcTerm.phylum)),
  CLASS_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.classKey", GbifTerm.classKey)),
  CLASS(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.class", DwcTerm.class_)),
  ORDER_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.orderKey", GbifTerm.orderKey)),
  ORDER(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.order", DwcTerm.order)),
  FAMILY_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.familyKey", GbifTerm.familyKey)),
  FAMILY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.family", DwcTerm.family)),
  GENUS_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.genusKey", GbifTerm.genusKey)),
  GENUS(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.genus", DwcTerm.genus)),
  SUBGENUS_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.subgenusKey", GbifTerm.subgenusKey)),
  SUBGENUS(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.subgenus", DwcTerm.subgenus)),
  SPECIES_KEY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.speciesKey", GbifTerm.speciesKey)),
  SPECIES(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.species", GbifTerm.species)),
  SCIENTIFIC_NAME(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usage.name", DwcTerm.scientificName)),
  SPECIFIC_EPITHET(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usageParsedName.specificEpithet", DwcTerm.specificEpithet)),
  INFRA_SPECIFIC_EPITHET(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usageParsedName.infraspecificEpithet", DwcTerm.infraspecificEpithet)),
  GENERIC_NAME(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.usageParsedName.genericName", DwcTerm.genericName)),
  TAXONOMIC_STATUS(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.diagnostics.status", DwcTerm.taxonomicStatus)),
  TAXON_ID(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.taxonID", DwcTerm.taxonID)),
  VERBATIM_SCIENTIFIC_NAME(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.verbatimScientificName", GbifTerm.verbatimScientificName)),
  IUCN_RED_LIST_CATEGORY(new BaseEsField("derivedMetadata.taxonomicCoverage.classification.iucnRedListCategoryCode", IucnTerm.iucnRedListCategory)),
