...
public class DownloadServiceImplTest {
  ...
  public void setup() {
    ...
    requestService = new DownloadRequestServiceImpl(oozieClient,
                                                    props,
                                                    "",
                                                    "",
                                                    downloadService,
                                                    mock(DownloadEmailUtils.class),
  ...
  public void testCreate() throws OozieClientException {
    ...
    DownloadRequest dl =
      new PredicateDownloadRequest(DEFAULT_TEST_PREDICATE, "markus", null, true, DownloadFormat.DWCA);
  ...
  private Download mockDownload(String downloadKey, String creator) {
    DownloadRequest downloadRequest =
      new PredicateDownloadRequest(DEFAULT_TEST_PREDICATE, creator, null, true, DownloadFormat.DWCA);
