...
public class OccurrenceSearchResource {
  ...
  @Parameters(
      value = {
        ...
        @Parameter(
            name = "basisOfRecord",
            description =
                "Basis of record, as defined in our BasisOfRecord vocabulary.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(
                    uniqueItems = true,
        ...
        @Parameter(
            name = "bed",
            description =
                "The full name of the lithostratigraphic bed from which the material entity was collected.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "collectionKey",
            description =
                "A key (UUID) for a collection registered in the [Global Registry of Scientific Collections]"
        ...
        @Parameter(
            name = "country",
            description =
                "The 2-letter country code (as per ISO-3166-1) of the country in which the occurrence "
                    + "was recorded.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
        ...
        @Parameter(
            ...
            description =
                "The degree to which an organism survives, reproduces and expands its range at the given "
        ...
        @Parameter(
            ...
            description =
                "The horizontal distance (in metres) of the occurrence from the nearest centroid known to be used "
        ...
        @Parameter(
            name = "dwcaExtension",
            description =
                "A known Darwin Core Archive extension RowType.  Limits the search to occurrences which have "
        ...
        @Parameter(
            ...
            description =
                "Whether an organism or organisms have been introduced to a given place and time through "
        ...
        @Parameter(
            name = "eventDate",
            description =
                "Occurrence date in ISO 8601 format: yyyy, yyyy-MM or yyyy-MM-dd.\n\n"
                    + API_PARAMETER_RANGE_OR_REPEAT,
        ...
        @Parameter(
            name = "formation",
            description =
                "The full name of the lithostratigraphic formation from which the material entity was collected.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "geoDistance",
            description =
                "Filters to match occurrence records with coordinate values within a specified distance of "
        ...
        @Parameter(
            name = "geometry",
            description =
                "Searches for occurrences inside a polygon described in Well Known Text (WKT) format. "
        ...
        @Parameter(
            name = "group",
            description =
                "The full name of the lithostratigraphic group from which the material entity was collected.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "hasCoordinate",
            description =
                "Limits searches to occurrence records which contain a value in both latitude and "
        ...
        @Parameter(
            ...
            description =
                "Includes/excludes occurrence records which contain spatial issues (as determined in our "
        ...
        @Parameter(
            name = "identifiedBy",
            description =
                "The person who provided the taxonomic identification of the occurrence.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "identifiedByID",
            description =
                "Identifier (e.g. ORCID) for the person who provided the taxonomic identification of the occurrence.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            ...
            description =
                "The occurrence installation key (a UUID).\n\n"
        ...
        @Parameter(
            name = "institutionKey",
            description =
                "A key (UUID) for an institution registered in the [Global Registry of Scientific Collections]"
                    + "(https://www.gbif.org/grscicoll).\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array = @ArraySchema(uniqueItems = true, schema = @Schema(implementation = UUID.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "issue",
            description =
                "A specific interpretation issue as defined in our OccurrenceIssue enumeration.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(
                    uniqueItems = true,
        ...
        @Parameter(
            name = "isInCluster",
            description =
                "*Experimental.* Searches for records which are part of a cluster.  See the documentation on "
        ...
        @Parameter(
            ...
            description =
                "The full name of the latest possible geochronologic age or highest chronostratigraphic "
                    + "stage attributable to the stratigraphic horizon from which the material entity was collected."
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
        ...
        @Parameter(
            name = "lifeStage",
            description =
                "The age class or life stage of an organism at the time the occurrence was recorded, as defined "
        ...
        @Parameter(
            name = "member",
            description =
                "The full name of the lithostratigraphic member from which the material entity was collected.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            name = "occurrenceId",
            description =
                "A globally unique identifier for the occurrence record as provided by the publisher.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            ...
            description =
                "Either `ABSENT` or `PRESENT`; the presence or absence of the occurrence.",
        ...
        @Parameter(
            ...
            description =
                "Previous assignment of name to the organism.\n\n" + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
            in = ParameterIn.QUERY,
        ...
        @Parameter(
            name = "protocol",
            description =
                "Protocol or mechanism used to provide the occurrence record.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(
                    uniqueItems = true,
        ...
        @Parameter(
            name = "recordedByID",
            description =
                "Identifier (e.g. ORCID) for the person who recorded the occurrence.\n\n"
                    + API_PARAMETER_MAY_BE_REPEATED,
            array =
                @ArraySchema(uniqueItems = true, schema = @Schema(implementation = String.class)),
            explode = Explode.TRUE,
        ...
        @Parameter(
            ...
            description =
                "The lithostratigraphy of an occurrence that is present in the group, formation, member and "
                    + "bed terms",
            explode = Explode.FALSE,
            in = ParameterIn.QUERY,
            example = "Wayne Fm"),
        @Parameter(
            ...
            description =
                "The biostratigraphy of an occurrence that is present in the lowest and highest "
                    + "biostratigraphy terms",
            explode = Explode.FALSE,
            in = ParameterIn.QUERY,
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Occurrence search is valid"),
        @ApiResponse(
            responseCode = "400",
