 ...
 */
public class GeoDistanceUdf implements UDF5<Number,Number,String,Double,Double,Boolean> {

  @Override
  @SneakyThrows
  public Boolean call(Number lat1, Number lon1, String distance, Double lat2, Double lon2) throws Exception {
    // sanitize the input
    if (lat1 == null || lon1 == null || distance == null || lat2 == null || lon2 == null || lat2 > 90 || lat2 < -90
      || lon2 > 180 || lon2 < -180) {
      return false;
    }
    return areInHaversineDistance(lat1.doubleValue(), lon1.doubleValue(), distance, lat2, lon2);
  }
