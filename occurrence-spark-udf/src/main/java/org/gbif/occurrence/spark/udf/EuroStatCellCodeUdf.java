 ...
 */
public class EuroStatCellCodeUdf implements UDF4<Integer,Double,Double,Number,String> {
  ...
  public String call(Integer gridSize, Double lat, Double lon, Number coordinateUncertaintyInMeters) throws Exception {
      return euroStatCellCode.fromCoordinate(gridSize, lat, lon,toDouble(coordinateUncertaintyInMeters));
  }
}
