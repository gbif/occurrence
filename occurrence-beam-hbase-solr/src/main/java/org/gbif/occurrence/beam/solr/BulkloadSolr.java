...
public class BulkloadSolr {
  ...
  private static final String SOLR_HOST = "c4zk1.gbif-uat.org,c4zk2.gbif-uat.org,c4zk3.gbif-uat.org/solr5";
  */

  private static final String HBASE_ZK = "c5zk1.gbif.org,c5zk2.gbif.org,c5zk3.gbif.org";
  private static final String HBASE_TABLE = "prod_f_occurrence";
  ...
  public static void main(String[] args) {
    ...
    int d = Integer.parseInt(options.getKeyDivisor());
    int r = Integer.parseInt(options.getKeyRemainder());
    ...
    docs.apply("write",
        SolrIO.write()
            ...
            .withRetryConfiguration(
                SolrIO.RetryConfiguration.create(10000, Duration.standardMinutes(1))));
