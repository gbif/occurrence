...
public interface OccurrenceWsSearchClient extends  OccurrenceSearchService {
  ...
  default SearchResponse<Occurrence, OccurrenceSearchParameter> search(@SpringQueryMap OccurrenceSearchRequest occurrenceSearchRequest) {
    return search(
        ...
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.DAY),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.COORDINATE_UNCERTAINTY_IN_METERS),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.VERBATIM_SCIENTIFIC_NAME),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.HOSTING_ORGANIZATION_KEY),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.ORGANISM_QUANTITY_TYPE),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.RELATIVE_ORGANISM_QUANTITY),
        ...
        occurrenceSearchRequest
            .getParameters()
            .get(OccurrenceSearchParameter.OTHER_CATALOG_NUMBERS),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.PREPARATIONS),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.START_DAY_OF_YEAR),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.END_DAY_OF_YEAR),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.GBIF_REGION),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.PUBLISHED_BY_GBIF_REGION),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.SEX),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.IS_SEQUENCED),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.TAXON_CONCEPT_ID),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.PREVIOUS_IDENTIFICATIONS),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.ISLAND),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.ISLAND_GROUP),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.GEOREFERENCED_BY),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.HIGHER_GEOGRAPHY),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.FIELD_NUMBER),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.EARLIEST_EON_OR_LOWEST_EONOTHEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LATEST_EON_OR_HIGHEST_EONOTHEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.EARLIEST_ERA_OR_LOWEST_ERATHEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LATEST_ERA_OR_HIGHEST_ERATHEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.EARLIEST_PERIOD_OR_LOWEST_SYSTEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LATEST_PERIOD_OR_HIGHEST_SYSTEM),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.EARLIEST_EPOCH_OR_LOWEST_SERIES),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LATEST_EPOCH_OR_HIGHEST_SERIES),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.EARLIEST_AGE_OR_LOWEST_STAGE),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LATEST_AGE_OR_HIGHEST_STAGE),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.LOWEST_BIOSTRATIGRAPHIC_ZONE),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.HIGHEST_BIOSTRATIGRAPHIC_ZONE),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.GROUP),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.FORMATION),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.MEMBER),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.BED),
        occurrenceSearchRequest.getParameters().get(OccurrenceSearchParameter.ASSOCIATED_SEQUENCES),
        occurrenceSearchRequest.getFacets());
  }
  ...
  SearchResponse<Occurrence, OccurrenceSearchParameter> search(@SpringQueryMap OccurrenceSearchRequest occurrenceSearchRequest,
                                                               ...
                                                               @RequestParam(value = "day", required = false) Set<String> day,
                                                               ...
                                                               @RequestParam(value = "startDayOfYear", required = false) Set<String> startDayOfYear,
                                                               @RequestParam(value = "endDayOfYear", required = false) Set<String> endDayOfYear,
                                                               @RequestParam(value = "gbifRegion", required = false) Set<String> gbifRegion,
                                                               @RequestParam(value = "publishedByGbifRegion", required = false) Set<String> publishedByGbifRegion,
                                                               @RequestParam(value = "sex", required = false) Set<String> sex,
                                                               @RequestParam(value = "isSequenced", required = false) Set<String> isSequenced,
                                                               @RequestParam(value = "taxonConceptId", required = false) Set<String> taxonConceptId,
                                                               @RequestParam(value = "previousIdentifications", required = false) Set<String> previousIdentifications,
                                                               @RequestParam(value = "island", required = false) Set<String> island,
                                                               @RequestParam(value = "islandGroup", required = false) Set<String> islandGroup,
                                                               @RequestParam(value = "georeferencedBy", required = false) Set<String> georeferencedBy,
                                                               @RequestParam(value = "higherGeography", required = false) Set<String> higherGeography,
                                                               @RequestParam(value = "fieldNumber", required = false) Set<String> fieldNumber,
                                                               @RequestParam(value = "earliestEonOrLowestEonothem", required = false) Set<String> earliestEonOrLowestEonothem,
                                                               @RequestParam(value = "latestEonOrHighestEonothem", required = false) Set<String> latestEonOrHighestEonothem,
                                                               @RequestParam(value = "earliestEraOrLowestErathem", required = false) Set<String> earliestEraOrLowestErathem,
                                                               @RequestParam(value = "latestEraOrHighestErathem", required = false) Set<String> latestEraOrHighestErathem,
                                                               @RequestParam(value = "earliestPeriodOrLowestSystem", required = false) Set<String> earliestPeriodOrLowestSystem,
                                                               @RequestParam(value = "latestPeriodOrHighestSystem", required = false) Set<String> latestPeriodOrHighestSystem,
                                                               @RequestParam(value = "earliestEpochOrLowestSeries", required = false) Set<String> earliestEpochOrLowestSeries,
                                                               @RequestParam(value = "latestEpochOrHighestSeries", required = false) Set<String> latestEpochOrHighestSeries,
                                                               @RequestParam(value = "earliestAgeOrLowestStage", required = false) Set<String> earliestAgeOrLowestStage,
                                                               @RequestParam(value = "latestAgeOrHighestStage", required = false) Set<String> latestAgeOrHighestStage,
                                                               @RequestParam(value = "lowestBiostratigraphicZone", required = false) Set<String> lowestBiostratigraphicZone,
                                                               @RequestParam(value = "highestBiostratigraphicZone", required = false) Set<String> highestBiostratigraphicZone,
                                                               @RequestParam(value = "group", required = false) Set<String> group,
                                                               @RequestParam(value = "formation", required = false) Set<String> formation,
                                                               @RequestParam(value = "member", required = false) Set<String> member,
