...
class SmallDownloadLauncherListenerTest {

  @Mock private SmallOccurrenceDownloadLauncherService occurrenceDownloadLauncherService;
  ...
  @InjectMocks private SmallDownloadLauncherListener listener;
  ...
  private DownloadLauncherMessage smallOccurrenceMessage(String downloadKey) {
    ...
    return new DownloadLauncherMessage(downloadKey, request);
  }

  @Test
  void testHandleMessageRunningStatus() throws Exception {
    String downloadKey = "small-key";
    DownloadLauncherMessage message = smallOccurrenceMessage(downloadKey);
  ...
  @Test
  void testHandleMessageAlreadyFinished() {
    String downloadKey = "small-key";
    DownloadLauncherMessage message = smallOccurrenceMessage(downloadKey);
  ...
  @Test
  void testHandleMessageFinishedStatus() {
    String downloadKey = "small-key";
    DownloadLauncherMessage message = smallOccurrenceMessage(downloadKey);
  ...
  @Test
  void testHandleMessageFailedStatusThrows() {
