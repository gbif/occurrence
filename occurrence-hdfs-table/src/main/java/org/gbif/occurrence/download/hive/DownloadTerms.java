...
public class DownloadTerms {
  ...
  public static final Set<Pair<Group, Term>> SIMPLE_DOWNLOAD_TERMS = ImmutableSet.of(
    ...
    Pair.of(Group.INTERPRETED, DwcTerm.superfamily),
    Pair.of(Group.INTERPRETED, DwcTerm.family),
    Pair.of(Group.INTERPRETED, DwcTerm.subfamily),
    Pair.of(Group.INTERPRETED, DwcTerm.tribe),
    Pair.of(Group.INTERPRETED, DwcTerm.subtribe),
