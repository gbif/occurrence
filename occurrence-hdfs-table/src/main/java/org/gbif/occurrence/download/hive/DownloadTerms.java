...
public class DownloadTerms {
  ...
  public static final Set<Term> EXCLUSIONS_INTERPRETED =
      ImmutableSet.of(
          ...
          DwcTerm.projectTitle, // only used by events
          DwcTerm.projectID, // only used by events
          DwcTerm.fundingAttribution, // only used by events
          DwcTerm.fundingAttributionID); // only used by events
  ...
  public static final Set<Term> DOWNLOAD_INTERPRETED_TERMS_HDFS =
      Sets.difference(ImmutableSet.copyOf(TermUtils.interpretedTerms()), EXCLUSIONS_HDFS)
          .immutableCopy();

  /** The interpreted terms included in a DWCA download. */
  public static final Set<Term> DOWNLOAD_INTERPRETED_TERMS =
      Sets.difference(ImmutableSet.copyOf(TermUtils.interpretedTerms()), EXCLUSIONS_DOWNLOAD)
          .immutableCopy();
  ...
  public static final Set<Term> DOWNLOAD_VERBATIM_TERMS =
      Sets.difference(ImmutableSet.copyOf(TermUtils.verbatimTerms()), EXCLUSIONS_HDFS)
          .immutableCopy();
  ...
  public static final Set<Term> DOWNLOAD_MULTIMEDIA_TERMS =
      Sets.difference(ImmutableSet.copyOf(TermUtils.multimediaTerms()), EXCLUSIONS_HDFS)
          .immutableCopy();
  ...
  public static final Set<Pair<Group, Term>> SIMPLE_WITH_VERBATIM_DOWNLOAD_TERMS =
      Sets.union(SIMPLE_DOWNLOAD_TERMS, ADDITIONAL_SIMPLE_WITH_VERBATIM_DOWNLOAD_TERMS)
          .immutableCopy();
  ...
  public static final Set<Term> INTERNAL_DOWNLOAD_TERMS =
      ImmutableSet.of(GbifInternalTerm.publishingOrgKey, IucnTerm.iucnRedListCategory);

  /** GBIF-Internal terms available for public searches (SQL downloads) */
  public static final Set<Term> INTERNAL_SEARCH_TERMS =
      ImmutableSet.of(
