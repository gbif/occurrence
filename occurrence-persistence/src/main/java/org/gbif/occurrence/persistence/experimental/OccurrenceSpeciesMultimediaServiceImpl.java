...
@Component
@Slf4j
public class OccurrenceSpeciesMultimediaServiceImpl implements OccurrenceSpeciesMultimediaService {
  ...
  @Autowired
  @SneakyThrows
  public OccurrenceSpeciesMultimediaServiceImpl(Connection connection,
  ...
  /**
   * Computes a salted key based on an expected number of buckets. The produced key is padded with
