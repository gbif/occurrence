...
public class TableConstants {
  ...
  public static final String VERBATIM_TERM_PREFIX = "v_";
  ...
  public static final String ISSUE_PREFIX = INTERNAL_PREFIX + "iss_";

  // An occurrence can have 0-n identifiers, each of a certain type. Their column names look like _t1, _i1, _t2, _i2, etc.
  public static final String IDENTIFIER_TYPE_COLUMN = INTERNAL_PREFIX + "t";
  public static final String IDENTIFIER_COLUMN = INTERNAL_PREFIX + "i";
